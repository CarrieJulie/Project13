...
function pinkBalloon() {
  ...
  pink.velocityX = 3;
  pink.lifetime = 150;
  pink = createEdgeSprites();
}

// || arrow.collide(green) || arrow.collide(blue) || arrow.collide(pink)